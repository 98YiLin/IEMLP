...
if choice == 1
    ...
    data = load('/root/Data/brunson_south-africa.txt');
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    data(:,3) = 1;
...
elseif choice == 2
    ...
    data = load('/root/Data/brunson_southern-women.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 3
...
elseif choice == 18
    ...
    data = load('/root/Data/moreno_taro.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 19
...
elseif choice == 23
    ...
    data = load('/root/Data/moreno_kangaroo.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 24
...
elseif choice == 25
    ...
    data = load('/root/Data/brunson_club-membership.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 26
...
elseif choice == 28
    ...
    data = load('/root/Data/brunson_corporate-leadership.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 29
...
elseif choice == 36
    ...
    data = load('/root/Data/moreno_rhesus.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 37
    disp('Working with out.moreno_zebra_zebra.txt data ...');
    data = load('/root/Data/out.moreno_zebra_zebra.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 38
...
elseif choice == 63
    ...
    data = load('/root/Data/brunson_revolution.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 64
...
elseif choice == 70
    ...
    data = load('/root/Data/moreno_sampson.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 71
...
elseif choice == 78
    ...
    data = load('/root/Data/bn-mouse_visual-cortex_2.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 79
...
elseif choice == 81
    ...
    data = load('/root/Data/DD_g1003.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 82
...
elseif choice == 85
    ...
    data = load('/root/Data/moreno_train.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 86
    disp('Working with morento_train.txt data ...');
    data = load('/root/Data/morento_train.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 87
...
elseif choice == 91
    ...
    data = load('/root/Data/moreno_sheep.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 92
    disp('Working with moreno_lesmis.txt data ...');
    data = load('/root/Data/moreno_lesmis.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 93
...
elseif choice == 96
    ...
    data = load('/root/Data/DD_g1056.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 97
...
elseif choice == 100
    ...
    data = load('/root/Data/gene_fusion.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 101
...
elseif choice == 106
    ...
    data = load('/root/Data/DD_g1031.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%下标索引必须为正整数类型或逻辑类型。
...
elseif choice == 110
    ...
    data = load('/root/Data/moreno_bison_bison.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 111
...
elseif choice == 113
    ...
    data = load('/root/Data/DD_g907.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 114
...
elseif choice == 115
    ...
    data = load('/root/Data/moreno_beach.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 116
    disp('Working with out.moreno_beach_beach.txt data ...');
    data = load('/root/Data/out.moreno_beach_beach.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 117
...
elseif choice == 120
    ...
    data = load('/root/Data/moren_hightschool.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 121
    disp('Working with moreno_highschool.txt data ...');
    data = load('/root/Data/moreno_highschool.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 122
...
elseif choice == 123
    ...
    data = load('/root/Data/moreno_seventh.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% elseif choice == 124
...
elseif choice == 127
    ...
    data = load('/root/Data/DD_g891.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 128
...
elseif choice == 129
    ...
    data = load('/root/Data/DD_g1041.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 130
    disp('Working with DD_g1093.txt data ...');
    data = load('/root/Data/DD_g1093.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 131
...
elseif choice == 133
    ...
    data = load('/root/Data/adjnoun_adjacency.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 134
    disp('Working with fs-adjnoun_adj_copperfield.txt data ...');
    data = load('/root/Data/fs-adjnoun_adj_copperfield.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 135
...
elseif choice == 137
    ...
    data = load('/root/Data/DD_g1027.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 138
...
elseif choice == 141
    ...
    data = load('/root/Data/DD_g1040.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 142
    disp('Working with DD_g1004.txt data ...');
    data = load('/root/Data/DD_g1004.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 143
    disp('Working with DD_g1015.txt data ...');
    data = load('/root/Data/DD_g1015.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 144
...
elseif choice == 148
    ...
    data = load('/root/Data/DD_g1121.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 149
...
elseif choice == 152
    ...
    data = load('/root/Data/DD_g1009.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 153
    disp('Working with DD_g1014.txt data ...');
    data = load('/root/Data/DD_g1014.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 154
...
elseif choice == 155
    ...
    data = load('/root/Data/DD_g927.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 156
...
elseif choice == 158
    ...
    data = load('/root/Data/DD_g1016.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 159
    disp('Working with DD_g913.txt data ...');
    data = load('/root/Data/DD_g913.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 160
    disp('Working with DD_g331.txt data ...');
    data = load('/root/Data/DD_g331.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 161
    disp('Working with DD_g324.txt data ...');
    data = load('/root/Data/DD_g324.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 162
...
elseif choice == 163
    ...
    data = load('/root/Data/DD_g895.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 164
    disp('Working with DD_g1070.txt data ...');
    data = load('/root/Data/DD_g1070.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% elseif choice == 165
...
elseif choice == 166
    ...
    data = load('/root/Data/DD_g899.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 167
...
elseif choice == 170
    ...
    data = load('/root/Data/DD_g258.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 171
    disp('Working with DD_g10.txt data ...');
    data = load('/root/Data/DD_g10.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 172
    disp('Working with DD_g322.txt data ...');
    data = load('/root/Data/DD_g322.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 173
    disp('Working with DD_g262.txt data ...');
    data = load('/root/Data/DD_g262.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 174
...
elseif choice == 177
    ...
    data = load('/root/Data/DD_g256.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 178
    disp('Working with DD_g1019.txt data ...');
    data = load('/root/Data/DD_g1019.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 179
    disp('Working with DD_g296.txt data ...');
    data = load('/root/Data/DD_g296.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 180
    disp('Working with DD_g958.txt data ...');
    data = load('/root/Data/DD_g958.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 181
    disp('Working with DD_g1012.txt data ...');
    data = load('/root/Data/DD_g1012.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 182
    disp('Working with edit-zh_min_nanwikibooks.txt data ...');
    data = load('/root/Data/edit-zh_min_nanwikibooks.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 183
...
elseif choice == 184
    ...
    data = load('/root/Data/DD_g1032.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 185
...
elseif choice == 186
    ...
    data = load('/root/Data/DD_g959.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 187
...
elseif choice == 188
    ...
    data = load('/root/Data/DD_g235.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 189
    disp('Working with DD_g1000.txt data ...');
    data = load('/root/Data/DD_g1000.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 190
...
elseif choice == 193
    ...
    data = load('/root/Data/DD_g297.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 194
    disp('Working with DD_g906.txt data ...');
    data = load('/root/Data/DD_g906.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 195
    disp('Working with DD_g236.txt data ...');
    data = load('/root/Data/DD_g236.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 196
...
elseif choice == 197
    ...
    data = load('/root/Data/DD_g589.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 198
...
elseif choice == 199
    ...
    data = load('/root/Data/DD_g1047.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 200
...
elseif choice == 202
    ...
    data = load('/root/Data/DD_g346.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 203
    disp('Working with DD_g961.txt data ...');
    data = load('/root/Data/DD_g961.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 204
    disp('Working with out.edit-zh_min_nanwikiquote.txt data ...');
    data = load('/root/Data/out.edit-zh_min_nanwikiquote.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 205
    disp('Working with DD_g182.txt data ...');
    data = load('/root/Data/DD_g182.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 206
    disp('Working with DD_g1049.txt data ...');
    data = load('/root/Data/DD_g1049.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 207
    disp('Working with DD_g1094.txt data ...');
    data = load('/root/Data/DD_g1094.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 208
    disp('Working with DD_g32.txt data ...');
    data = load('/root/Data/DD_g32.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 209
    disp('Working with DD_g334.txt data ...');
    data = load('/root/Data/DD_g334.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 210
...
elseif choice == 211
    ...
    data = load('/root/Data/DD_g292.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 212
...
elseif choice == 213
    ...
    data = load('/root/Data/DD_g908.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 214
    disp('Working with DD_g341.txt data ...');
    data = load('/root/Data/DD_g341.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 215
    disp('Working with DD_g285.txt data ...');
    data = load('/root/Data/DD_g285.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 216
    disp('Working with DD_g43.txt data ...');
    data = load('/root/Data/DD_g43.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 217
    disp('Working with DD_g267.txt data ...');
    data = load('/root/Data/DD_g267.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 218
    disp('Working with DD_g430.txt data ...');
    data = load('/root/Data/DD_g430.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 219
    disp('Working with DD_g295.txt data ...');
    data = load('/root/Data/DD_g295.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 220
    disp('Working with DD_g928.txt data ...');
    data = load('/root/Data/DD_g928.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 221
...
elseif choice == 222
    ...
    data = load('/root/Data/moreno_innovation.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 223
...
elseif choice == 226
    ...
    data = load('/root/Data/bn-cat-mixed-species_brain_1.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 227
    disp('Working with DD_g238.txt data ...');
    data = load('/root/Data/DD_g238.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 228
...
elseif choice == 231
    ...
    data = load('/root/Data/moreno_mac.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 232
...
elseif choice == 233
    ...
    data = load('/root/Data/DD_g255.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 234
...
elseif choice == 235
    ...
    data = load('/root/Data/DD_g151.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 236
    disp('Working with DD_g333.txt data ...');
    data = load('/root/Data/DD_g333.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 237
...
elseif choice == 239
    ...
    data = load('/root/Data/DD_g332.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 240
...
elseif choice == 246
    ...
    data = load('/root/Data/DD_g1022.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 247
    disp('Working with moreno_crime_crime.txt data ...');
    data = load('/root/Data/moreno_crime_crime.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 248
    disp('Working with DD_g162.txt data ...');
    data = load('/root/Data/DD_g162.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 249
...
elseif choice == 251
    ...
    data = load('/root/Data/DD_g942.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 252
    disp('Working with DD_g150.txt data ...');
    data = load('/root/Data/DD_g150.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 253
...
elseif choice == 255
    ...
    data = load('/root/Data/out.wiki_talk_ht.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 256
    disp('Working with DD_g170.txt data ...');
    data = load('/root/Data/DD_g170.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 257
...
%     data = load('/root/Data/bn-macaque-rhesus_cerebral-cortex_1.txt');
%     data(:,3) = 1;
%     Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 266
...
elseif choice == 267
    ...
    data = load('/root/Data/dimacs10-celegans_metabolic.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 268
...
elseif choice == 276
    ...
    data = load('/root/Data/morent_protein.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 277
    disp('Working with out.moreno_propro_propro.txt data ...');
    data = load('/root/Data/out.moreno_propro_propro.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 278
...
elseif choice == 279
    ...
    data = load('/root/Data/Celegans_w.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 280
...
elseif choice == 289
    ...
    data = load('/root/Data/out_maayan.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 290
...
elseif choice == 291
    ...
    data = load('/root/Data/bn-macaque-rhesus_interareal-cortical-network_2.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 292
...
elseif choice == 293
    ...
    data = load('/root/Data/moreno_oz.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 294
...
elseif choice == 302
    ...
    data = load('/root/Data/facebook_nips.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 303
...
elseif choice == 304
    ...
    data = load('/root/Data/moreno_vdb.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 305
...
elseif choice == 330
    ...
    data = load('/root/Data/GD01_b.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 331
    disp('Working with GD06_theory.txt data ...');
    data = load('/root/Data/GD06_theory.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 332
    disp('Working with GD97_a.txt data ...');
    data = load('/root/Data/GD97_a.txt');
    data(:,3) = 1;
    Adj = form_net(data, weight, direction);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
elseif choice == 333
